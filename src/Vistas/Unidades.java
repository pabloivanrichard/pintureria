 ...
 * @author laura
 */
public class Unidades extends javax.swing.JDialog {
  int  menu=Menu.opcion; // variable q viene del Menu para el abm
    TipoUnidades tipou;
    /**
     * Creates new form Unidades
     */
    public Unidades(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tipos de Unidades:");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (jTable1.getSelectedRow() != -1) {
            ...
            tipou = new TipoUnidadesJpaController(emf).findTipoUnidades(valor);
            jTextField1.setText(tipou.getDescripcion());
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(menu==1){
            if(jTextField1.getText()!=null){
                ...
                TipoUnidadesJpaController cjc= new TipoUnidadesJpaController(emf);
                cjc.create(tipouni);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Unidades dialog = new Unidades(new javax.swing.JFrame(), true);
    ...
    private void inicializarComponentes() {
     ...
     public void llenarTabla(){
        List<TipoUnidades> lista;
        lista=new FacadeTipoUnidades().listar();
